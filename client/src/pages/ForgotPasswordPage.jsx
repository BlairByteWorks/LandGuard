...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Assuming your backend has an endpoint like this set up
      ...
      console.error(error);
      setStatus('error');
      // If the backend sends a specific error message, use it, otherwise show a generic one
      setErrorMessage(
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4 font-sans">
      ...
      <div className="w-full max-w-[480px] bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden relative">
        ...
        {/* Loading Overlay (Optional subtle touch) */}
        {status === 'loading' && (
